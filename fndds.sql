...
SELECT main_food_desc, nut_desc, nutval FROM nut_vals INNER JOIN nut_desc using (nutcode) INNER JOIN main_food_desc USING (foodcode) WHERE nut_desc = '~Energy~' ORDER BY nutval;
